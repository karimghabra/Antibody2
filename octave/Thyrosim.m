...
% Conversion factors. Molecular weight over liters
% Note that conversion is actually done in THYROSIM->postProcess(), so this is
% here for reference rather than use.
%T4conv  = 777/p47;
%T3conv  = 651/p47;
%TSHconv = 5.6/p48;
...
q0 = [IC1;  IC2;  IC3;  IC4;  IC5;  IC6;  IC7;  IC8;  IC9;
