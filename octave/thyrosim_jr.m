% FILE: thyrosim_jr.m
% adapted from thyrosim.m written by Simon X. Han
% Adjusted by Doug Dang, Aaron Hui, Sandy Kim, Amanda Tsao

% Main function
function thyrosim_jr
...
p(12) = 0.0189;         %k02
p(13) = 3.85*10^(-4);   %VmaxD1fast
p(14) = 2.85;           %KmD1fast
p(15) = 6.63*10^-4;     %VmaxD1slow
p(16) = 95;             %KmD1slow
p(17) = 0.00109;        %VmaxD2slow
p(18) = 0.075;          %KmD2slow
p(19) = 3.71*10^-4;     %S3
p(20) = 5.37;           %k45
p(21) = 0.0689;         %k46
...
% General
figure('Name','Thyrosim Junior Results','NumberTitle','off');
